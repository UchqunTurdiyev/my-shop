	...
	return (
		<header className='text-gray-600 body-font bg-slate-200 '>
			<div className='container mx-auto flex flex-col md:flex-row p-5 justify-between items-center'>
				...
				<nav className='md:mr-auto  md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400 flex	md:flex-row  felx-col  items-center text-base justify-center'>
				...
				<Link href={'/shopping-card'}>
					<button className='inline-flex items-center text-white bg-blue-600 mt-4  md:mt-0 py-1 px-3 focus:outline-none hover:bg-transparent hover:border-blue-600 border-2 hover:text-blue-600 rounded text-base '>
